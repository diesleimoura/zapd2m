...
const fallback = {
  ...
  sections: [
    ...
    { title: "6. Propriedade Intelectual", content: "Todo o conteúdo da plataforma, incluindo código-fonte, design, logotipos, textos e funcionalidades, é de propriedade exclusiva da ZapMax e está protegido por leis de propriedade intelectual. É proibida a reprodução, distribuição ou modificação sem autorização prévia." },
